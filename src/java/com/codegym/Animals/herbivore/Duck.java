...
//@Emoji
//@Data
@ParametersWithHerbivore(weight = 1, maxCountPerCell = 200, speedCellsPerTurn = 4, maxSaturation = 0.15)
public class Duck implements Animal {

    private char symbol = '5'; // later emoji;
    private int x;
    private int y;
    private int energy; // max 0.15 - "1";
    private int id;
